---@module 'migrate.hl'
---@brief Migrate vim.highlight.* to vim.hl.* (removed in favor of vim.hl).
---@description
--- Same shape as `migrate.opt`: line/range/buffer(`%`)/cwd modes through the
--- shared `migrate.common.command` factory.
...
local notify = require("lib.nvim.notify").create("[migrate.hl]")
